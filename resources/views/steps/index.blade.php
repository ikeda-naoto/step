...
@section('main')
    ...
    <div class="p-lp">
        <section class="p-lp__group p-about u-pt--0 js-animate-fadeIn">
            ...
            <div class="p-lp__inner u-position--relative">
                ...
                <p class="p-about__text">
                    「STEP」では、あらゆるジャンルにおいて「良い」と思った学習順序を共有し、それを元に「効率的習を進めることができます。
                </p>
        ...
        <section class="p-lp__group p-wall js-animate-fadeIn">
        ...
        <section class="p-lp__group p-feature u-pt--0 u-bg--light js-animate-fadeIn">
        ...
        <section class="p-lp__group p-browse u-pb--0 js-animate-fadeIn">
            <div class="l-site-width">
                <div class="p-lp__head">
                    ...
                    @foreach ($parentSteps as $parentStep)
                        <a href="{{ route('steps.showParent', $parentStep->id) }}" class="l-row__col12--sm  l-row__col06--tab l-row__col04--pc p-step-list__panel-container">
                            <div class="c-panel p-step-list__panel">
                                <div class="c-panel__category p-step-list__category">
                                    {{ $parentStep->category->name }}
                                </div>
                                ...
                                <div class="l-row l-row--between p-step-list__head">
                                    <h3 class="c-panel__title p-step-list__title">
                                        {{ $parentStep->title }}
                                    </h3>
                                </div>
                                <div class="l-row l-row--between l-row--center p-step-list__body">
                                    <p class="p-step-list__time">
                                        目安達成時間：{{ $parentStep->time}}時間
                                    </p>
                                    <p class="p-step-list__sum">
                                        全{{ count($parentStep->childSteps)  }}STEP
                                    </p>
                                </div>
                            </div>
                        </a>
