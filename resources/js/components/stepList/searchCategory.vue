...
<div class="c-sidebar__group"> 
    ...
    <div class="c-sidebar__body">
        <ul class="c-sidebar__list">
            <li class="c-sidebar__list-item" :class="[selectCategory === 0 ? 'c-sidebar__list-item--active' : '']" v-scroll-to="'#top'">
            ...
            <li class="c-sidebar__list-item" v-for="category in categories" :key="category.id" :class="[selectCategory === category.id ? 'c-sidebar__list-item--active' : '']" v-scroll-to="'#top'">
