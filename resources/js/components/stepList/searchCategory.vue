    ...
    <div class="c-sidebar__body">
        <ul class="c-sidebar__list">
            <li class="c-sidebar__list-item" :class="[selectCategory === 0 ? 'c-sidebar__list-item--active' : '']">
                <input type="radio" name="category" :id="0"  class="c-sidebar__radio" :value="0" @input="updateSelectCategory($event.target.value)">
            ...
            <li class="c-sidebar__list-item" v-for="category in categories" :key="category.id" :class="[selectCategory === category.id ? 'c-sidebar__list-item--active' : '']">
                <input type="radio" name="category" :id="category.id"  class="c-sidebar__radio" :value="category.id" @input="updateSelectCategory($event.target.value)">
